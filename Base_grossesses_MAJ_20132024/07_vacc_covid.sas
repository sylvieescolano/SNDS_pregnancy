...
'3400930264058', '3400930243404'='PBNT'
'3400930243411'='BNT'
'3400930245774'='NVX'
...
proc format;
value $type_vac
'3400930219553','3400930259528','3400930266472','3400930262009','3400930264058',
...
/*numeroter les injections pour chaque BNA + retirer les injections >2024 */
proc sort data=WORK.vac3; by ben_nir_ano exe_soi_dtd; run;
data vac4;
    set WORK.vac3 (where=(exe_soi_dtd is missing or (exe_soi_dtd between '01jan2013'd and '31dec2024'd)));
    by ben_nir_ano exe_soi_dtd;
    num_vac +1;
...
/*Verifier la date de la derniere injection (derniere MAJ IR VAC F juin 2024)*/
PROC SQL;
   CREATE TABLE WORK.max AS 
   SELECT /* MAX_of_EXE_SOI_DTD */
            (MAX(t1.EXE_SOI_DTD)) FORMAT=DDMMYYS10. AS MAX_of_EXE_SOI_DTD
      FROM rep.vacCOVID t1;
QUIT;
